...
//--------------------------------------------------------------------------------
ViewOcclusion::ViewOcclusion( ArkRenderer11& Renderer, ResourcePtr OcclusionTarget, ResourcePtr BlurTarget, ResourcePtr DepthNormalTarget )
{
	...
	pOcclusionEffect = new ArkRenderEffect11();
	...
	pBilateralXEffect = new ArkRenderEffect11();
	...
	pBilateralYEffect = new ArkRenderEffect11();
...
//--------------------------------------------------------------------------------
void ViewOcclusion::QueuePreTasks( ArkRenderer11* pRenderer )
{
	// Queue this view into the renderer for processing.
	pRenderer->QueueTask( this );
}
//--------------------------------------------------------------------------------
void ViewOcclusion::ExecuteTask( PipelineManager* pPipelineManager, IParameterManager* pParamManager )
{
...
void ViewOcclusion::SetRenderParams( IParameterManager* pParamManager )
{
	...
	pParamManager->SetUnorderedAccessParameter(std::dynamic_pointer_cast<ArkRenderParameter11>(m_pAmbientOcclusionTarget), OcclusionBuffer );
}
//--------------------------------------------------------------------------------
void ViewOcclusion::SetUsageParams( IParameterManager* pParamManager )
{
	...
	pParamManager->SetShaderResourceParameter(std::dynamic_pointer_cast<ArkRenderParameter11>(m_pAmbientOcclusionBuffer), OcclusionBuffer );
}
//--------------------------------------------------------------------------------
