...
//ViewOcclusion.h
//--------------------------------------------------------------------------------
#ifndef __ViewCSMShadowMap_h__
#define __ViewCSMShadowMap_h__
//--------------------------------------------------------------------------------
#include "TaskCore.h"
...
namespace Arkeng
{
	...
	class ViewCascadedShadowMap : public RenderTask
	{
	public:
		ViewCascadedShadowMap(ArkRenderer11& Renderer,const ViewSettings& Setting);
		virtual ~ViewCascadedShadowMap();
