...
//--------------------------------------------------------------------------------
ArkSpriteFont11::ArkSpriteFont11() :  
	m_FontName( L"" ),
	m_fSize( 0 ),
	m_uiFontStyle( 0 ),
...
//--------------------------------------------------------------------------------
bool ArkSpriteFont11::Initialize( std::wstring& fontName, float fontSize, UINT fontStyle, bool antiAliased )
{
	m_FontName = fontName;
	m_fSize = fontSize;
...
//--------------------------------------------------------------------------------
const ArkSpriteFont11::CharDesc* ArkSpriteFont11::CharDescriptors() const
{
	return m_CharDescs;
}
//--------------------------------------------------------------------------------
const ArkSpriteFont11::CharDesc& ArkSpriteFont11::GetCharDescriptor(WCHAR character) const
{
	_ASSERT(character >= StartChar && character <= EndChar);
	return m_CharDescs[character - StartChar];
}
//--------------------------------------------------------------------------------
std::wstring ArkSpriteFont11::FontName() const
{
	return( m_FontName );
}
//--------------------------------------------------------------------------------
float ArkSpriteFont11::Size() const
{
	return( m_fSize );
}
//--------------------------------------------------------------------------------
UINT ArkSpriteFont11::FontStyle() const
{
	return( m_uiFontStyle );
}
//--------------------------------------------------------------------------------
bool ArkSpriteFont11::AntiAliased() const
{
	return( m_bAntiAliased );
}
//--------------------------------------------------------------------------------
UINT ArkSpriteFont11::TextureWidth() const
{
	return TexWidth;
}
//--------------------------------------------------------------------------------
UINT ArkSpriteFont11::TextureHeight() const
{
	return m_uTexHeight;
}
//--------------------------------------------------------------------------------
float ArkSpriteFont11::SpaceWidth() const
{
	return m_fSpaceWidth;
}
//--------------------------------------------------------------------------------
float ArkSpriteFont11::CharHeight() const
{
	return m_fCharHeight;
}
//--------------------------------------------------------------------------------
ResourcePtr ArkSpriteFont11::TextureResource() const
{
	return m_pTexture;
}
//--------------------------------------------------------------------------------
float ArkSpriteFont11::GetStringWidth( const std::wstring& text )
{
	float fWidth = 0.0f;
