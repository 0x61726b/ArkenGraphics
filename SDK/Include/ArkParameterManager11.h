...
namespace Arkeng
{
	...
	public:
		...
		virtual void SetMatrixArrayParameter(std::shared_ptr<ArkRenderParameter11> pP,DirectX::XMFLOAT4X4* pV);
		...
		virtual std::shared_ptr<ArkMatrixArrayParameter11> GetMatrixArrayParameterRef(const std::wstring& name) ;
