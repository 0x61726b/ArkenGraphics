...
//
//Dx11DepthStencilViewConfig.h
//--------------------------------------------------------------------------------
#ifndef __Dx11DepthStencilViewConfig_h__
#define __Dx11DepthStencilViewConfig_h__
//--------------------------------------------------------------------------------
...
namespace Arkeng
{
	...
	{
	public:
		Dx11DepthStencilViewConfig();
		virtual ~Dx11DepthStencilViewConfig();
