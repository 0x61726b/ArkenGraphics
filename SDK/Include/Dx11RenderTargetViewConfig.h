...
//
//Dx11RenderTargetViewConfig.h
//--------------------------------------------------------------------------------
#ifndef __Dx11RenderTargetViewConfig_h__
#define __Dx11RenderTargetViewConfig_h__
//--------------------------------------------------------------------------------
...
namespace Arkeng
{
	...
	{
	public:
		Dx11RenderTargetViewConfig();
        virtual ~Dx11RenderTargetViewConfig();
